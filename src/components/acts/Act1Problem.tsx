    ...
    <div className="w-full h-full relative">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        >
          ...
          <h1 className="font-display tracking-tight text-5xl md:text-7xl lg:text-8xl font-extrabold text-[#EDF1FF]">
        ...
        <div className="absolute left-[4vw] md:left-[55vw] top-[32vh] md:top-[30vh] w-[92vw] md:w-[420px] pointer-events-auto">
