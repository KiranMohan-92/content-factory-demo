            ...
            <GlassCard className="max-w-[95vw] md:max-w-4xl px-6 md:px-8 py-5 md:py-6 w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                {(['researcher', 'analyzer', 'writer', 'editor', 'codex', 'orchestrator'] as const).map(key => {
                  ...
                  return (
                    <div key={key} className="glass-card p-3 md:p-4" style={{ borderColor: `${color}15` }}>
          ...
          {tab === 'System' && (
            <GlassCard className="max-w-[95vw] md:max-w-3xl px-6 md:px-8 py-5 md:py-6 w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-5 text-base md:text-lg font-body">
                <div className="glass-card bg-lime/3 border-lime/8 p-4 md:p-5">
                ...
                <div className="glass-card bg-cyan/3 border-cyan/8 p-4 md:p-5">
                ...
                <div className="glass-card bg-purple/3 border-purple/8 p-4 md:p-5">
                ...
                <div className="glass-card bg-orange/3 border-orange/8 p-4 md:p-5">
