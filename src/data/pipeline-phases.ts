...
export const pipelinePhases: PipelinePhase[] = [
  ...
  },
  {
    ...
    description: '7-pass systematic review across 7 quality dimensions. Minimum 9.3/10 to proceed.',
    output: 'editor-feedback.md',
    color: '#f59e0b',
    icon: 'Edit3',
    gate: { threshold: 9.3, label: 'Editor Gate' },
  },
  {
    id: 'codex',
    label: 'CODEX Review',
    agent: 'CODEX Brutal Critic v2.2',
    description: 'Hostile cross-examination. Stress-tests claims, searches counterexamples. 9.5/10 minimum.',
    output: 'codex-feedback.md',
    color: '#ec4899',
    icon: 'Shield',
    gate: { threshold: 9.5, label: 'CODEX Gate' },
  },
]
